...
export function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <aside className="sticky top-0 hidden h-dvh w-[21rem] shrink-0 overflow-hidden px-4 py-4 text-sidebar-foreground lg:flex">
      <div className="surface-panel flex min-h-0 w-full flex-1 flex-col bg-sidebar/82 text-sidebar-foreground">
        <div
          aria-hidden="true"
          className="surface-orb -left-10 top-0 h-36 w-36 bg-primary/14"
        />
        <div className="flex h-28 shrink-0 items-center border-b border-sidebar-border/70 px-6">
          <Link
            href="/dashboard"
        ...
        <div className="min-h-0 flex-1 px-3 pb-4 pt-4">
          <nav className="sidebar-scroll h-full min-h-0 overflow-y-auto px-1 py-1">
